...
class ExampleMenuToggle extends QuickSettings.QuickMenuToggle {
    _init(extensionObject) {
        ...
        this.menu.setHeader('network-server-symbolic', _('DNS'));
        ...
        this.menu.addHeaderSuffix(editButton);
		...
		Object.keys(this.DNS_PRESETS).forEach(provider => {
			this._itemsSection.addAction(_(provider),() => this._changeDNS(provider));
		});
...
class ExampleIndicator extends SystemIndicator {
    constructor(extensionObject) {
        ...
        const toggle = new ExampleMenuToggle(extensionObject);
